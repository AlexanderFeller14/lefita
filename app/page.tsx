        ...
        >
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <article className="group card-plain flex flex-col items-start gap-4 p-5">
              <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-moss/25 bg-moss/10 text-moss transition group-hover:bg-moss/20">
            ...
            {/* Grosse Hunde */}
            <article className="group card-plain flex flex-col items-start gap-4 p-5">
              <span className="flex h-12 w-12 items-center justify-center rounded-2xl border border-pine/15 bg-pine/[0.06] text-pine/70 transition group-hover:bg-pine/10">
                <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
